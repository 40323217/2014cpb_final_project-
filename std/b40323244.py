...
class Application(object):
    ...
    def __init__(self):
        ...
        self.name = '曾裕翔'
        # 你的學號
        self.number = '40323244'
        # 你的班級
        self.classes = '四設一乙'
        # 你的 github repository url
        self.github_repo_url = 'https://github.com/40323244/40323244.git'
        # 你的 openshift app
        self.openshift_url = 'http://final-40323244.rhcloud.com/'
        # 你的自評
        self.evaluation = [('期末自我評量', 80)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/LvNWxDFmEcOzfnej'
        # 這裡是心得
        self.my_remark = """
        在操作過程中非常困難，有很多地方不懂，但是經過同學的幫忙與指導，漸漸地懂得程式的運用，感覺還不錯。
        """
