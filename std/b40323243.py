...
class Application(object):
    ...
    def __init__(self):
        ...
        self.name = '曾彥鈞'
        # 你的學號
        self.number = '40323243'
        # 你的班級
        self.classes = '四設一乙'
        # 你的 github repository url
        self.github_repo_url = 'https://github.com/40323243/--2014cp_project_40323243'
        # 你的 openshift app
        self.openshift_url = 'http://2014project-2014cpfall.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 80), ('Project 8', 90), ('Project 9', 100)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/XWagU0N9witKQKFc'
        # 這裡是心得
        self.my_remark = """
        謝謝老師的指導，讓我們學習如何製作python。
        """
