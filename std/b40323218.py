...
class Application(object):
    ...
    def __init__(self):
        ...
        # 這裡是心得
        self.my_remark = """
        這學期教的python課程讓我學到許多，從一開始什麼都不懂到現在學會一些基礎，雖然這些只是基礎中的基礎，但也讓我獲益良多。
        每次上課聽老師的講解雖然有時一知半解，但在同學和TA的幫助下已經可以把功課做出來了。
        這學期學會如何使用在openshift建立內容、在github建立倉儲、在Leo Editer管理自己的內容，只能說學會了太多太多。
