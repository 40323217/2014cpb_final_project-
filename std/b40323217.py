...
class Application(object):
    ...
    def __init__(self):
        ...
        # 這裡是心得
        self.my_remark = """
       在快速的時代需要有一種工具可以快速的寫好程式(python),並且在近端遠端都有備份,以及在做專案的時候可以有協同者(collabortors)共同開發專案,還有能夠使用github、bitbucket、cherrypy這些都是在這學期的計算機程式當中很重要的一環,假如程式在遠端近端都有備份近端電腦如果發生問題,資料在遠端還會有備份github的功能),在來就是開發個人服務功能,客戶網站上輸入需要的工具或是商品,輸入他們需要的尺寸或者商品編號,能夠自動出現"客製化"的商品達到滿足客戶的要求,這也是本學期重要的一環.
