...
class Application(object):
    ...
    def __init__(self):
        ...
        self.name = '程偉銓'
        # 你的學號
        self.number = '40323245'
        # 你的班級
        self.classes = '四設一乙'
        # 你的 github repository url
        self.github_repo_url = 'https://github.com/40323245/2014cp_project_40323245'
        # 你的 openshift app
        self.openshift_url = 'http://2014cp-40323245.rhcloud.com/'
        # 你的自評
        self.evaluation = [('Project 7', 80), ('Project 8', 90), ('Project 9', 100)]
        # 你的照片 url
        self.photo_url = 'https://copy.com/31EgsBtJHUtFG6Tt'
        # 這裡是心得
        self.my_remark = """
        終於完成了期末報告，完全無法靠自己的力量，還是需要老師的影片以及同學的範例才能完成任務！
        """
